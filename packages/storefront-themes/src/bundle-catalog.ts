...
export const BUNDLE_2023_CATALOG: BundleTemplateCatalogEntry[] = [
  ...
  { num: 31, bundleFile: "31 painter-1.0.0.zip", proposedId: "painter", label: "Painter", detectedTitle: "PAINTER - Painting Company", shopCategory: "House Painting & Decorating", status: "queued-storefront", storefrontFit: "service-booking", similarIntegratedId: "aircon", notes: "House painting contractor quotes — maps to aircon until dedicated port." },
  ...
  { num: 52, bundleFile: "52 haircut-1.0.0.zip", proposedId: "haircut", label: "HairCut Salon", detectedTitle: "HairCut - Hair Salon HTML", shopCategory: "Barber & Hair Salons", status: "integrated", storefrontFit: "service-booking", notes: "Barber/salon appointments + grooming products.", portPriority: 5 },
  ...
  { num: 99, bundleFile: "99 apex-1.0.0.zip", proposedId: "apex", label: "Apex Home Repair", detectedTitle: "Apex - Home Repair Website", shopCategory: "Home Services & Trades", status: "queued-storefront", storefrontFit: "service-booking", similarIntegratedId: "aircon", notes: "Handyman/home + on-demand repair services — also fits Appliance & Device Repair." },
