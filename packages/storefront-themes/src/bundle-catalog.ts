...
export const BUNDLE_2023_CATALOG: BundleTemplateCatalogEntry[] = [
  ...
  { num: 12, bundleFile: "12 studio-master.zip", proposedId: "studio", label: "Studio Photography", detectedTitle: "Studio - Creative Photography", shopCategory: "Photography & Creative", status: "queued-storefront", storefrontFit: "service-booking", notes: "Photo packages, prints, session booking." },
  ...
  { num: 36, bundleFile: "36 motto-1.0.0.zip", proposedId: "motto", label: "Motto Moto", detectedTitle: "moto", shopCategory: "Auto Shop & Services", status: "queued-storefront", storefrontFit: "ecommerce", notes: "Motorcycle / moto gear shop." },
  ...
  { num: 49, bundleFile: "49 insure-1.0.0.zip", proposedId: "insure", label: "Insure", detectedTitle: "Insure - Insurance HTML", shopCategory: "Insurance & Financial Services", status: "queued-storefront", storefrontFit: "service-booking", notes: "Insurance quotes + policy sales." },
  ...
  { num: 62, bundleFile: "62 finanza-1.0.0.zip", proposedId: "finanza", label: "Finanza", detectedTitle: "Finanza - Financial Services", shopCategory: "Insurance & Financial Services", status: "queued-storefront", storefrontFit: "service-booking", similarIntegratedId: "insure", notes: "Financial advisory services." },
  ...
  { num: 67, bundleFile: "67 ensurance-v1.0.0.zip", proposedId: "ensurance", label: "Ensurance", detectedTitle: "Ensurance | Landing & Corporate", shopCategory: "Insurance & Financial Services", status: "queued-storefront", storefrontFit: "service-booking", similarIntegratedId: "insure", notes: "Insurance corporate landing." },
  ...
  { num: 87, bundleFile: "87 carserv-1.0.0.zip", proposedId: "carserv", label: "CarServ", detectedTitle: "CarServ - Car Repair HTML", shopCategory: "Auto Shop & Services", status: "queued-storefront", storefrontFit: "service-booking", notes: "Auto repair booking + parts." },
  ...
  { num: 100, bundleFile: "100 aircon-1.0.0.zip", proposedId: "aircon", label: "AirCon", detectedTitle: "AirCon - AC Repair Website", shopCategory: "HVAC & Air Conditioning", status: "queued-storefront", storefrontFit: "service-booking", notes: "AC install/repair — high-priority PH vertical." },
];
