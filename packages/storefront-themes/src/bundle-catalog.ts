...
export const BUNDLE_2023_CATALOG: BundleTemplateCatalogEntry[] = [
  ...
  { num: 12, bundleFile: "12 studio-master.zip", proposedId: "studio", label: "Studio Photography", detectedTitle: "Studio - Creative Photography", shopCategory: "Photography & Creative", status: "queued-storefront", storefrontFit: "service-booking", notes: "Photo packages, prints, session booking. Interim port target for Printing & Signage until a dedicated print theme exists.", portPriority: 4 },
  ...
  { num: 36, bundleFile: "36 motto-1.0.0.zip", proposedId: "motto", label: "Motto Moto", detectedTitle: "moto", shopCategory: "Auto Shop & Services", status: "queued-storefront", storefrontFit: "ecommerce", notes: "Motorcycle / moto gear shop.", portPriority: 3 },
  ...
  { num: 87, bundleFile: "87 carserv-1.0.0.zip", proposedId: "carserv", label: "CarServ", detectedTitle: "CarServ - Car Repair HTML", shopCategory: "Auto Shop & Services", status: "queued-storefront", storefrontFit: "service-booking", notes: "Auto repair booking + parts.", portPriority: 2 },
  ...
  { num: 100, bundleFile: "100 aircon-1.0.0.zip", proposedId: "aircon", label: "AirCon", detectedTitle: "AirCon - AC Repair Website", shopCategory: "HVAC & Air Conditioning", status: "queued-storefront", storefrontFit: "service-booking", notes: "AC install/repair — high-priority PH vertical.", portPriority: 1 },
];
