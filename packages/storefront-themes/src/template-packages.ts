...
export const TEMPLATE_PACKAGES: Partial<Record<ShopTemplateId, TemplatePackageMetadata>> = {
  ...
  haircut: {
    id: "haircut",
    industryFit: ["Barber & Hair Salons", "Beauty Salons & Spas"],
    idealProductCount: { min: 3, max: 30 },
    targetAudience: ["barbershops", "hair salons", "grooming studios"],
    visualStyle: ["bold", "premium"],
    conversionFocus: "booking",
    mobileScore: 88,
    liveSellingReady: false,
    seoReady: true,
  ...
  specialty: {
    ...
    idealProductCount: { min: 1, max: 8 },
    targetAudience: ["specialty sellers", "repair shops", "signature service businesses"],
    visualStyle: ["minimal", "premium"],
    conversionFocus: "catalog",
    mobileScore: 90,
    liveSellingReady: true,
