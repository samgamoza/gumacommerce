    ...
    <div className="space-y-4">
      <Card className="p-5">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-foreground">How Workspace works</h2>
        </div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/workspace/marketing" className="block">
          <Card className="h-full p-5 transition hover:border-emerald-300">
            ...
            <h3 className="mt-2 font-semibold text-foreground">Marketing</h3>
            <p className="mt-1 text-sm text-muted-foreground">
        ...
        <Link href="/workspace/automations" className="block">
          <Card className="h-full p-5 transition hover:border-emerald-300">
            ...
            <h3 className="mt-2 font-semibold text-foreground">Automations</h3>
            <p className="mt-1 text-sm text-muted-foreground">
      ...
      <Card className="border-dashed p-5">
        <p className="text-sm text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 text-xs">domain_events</code>.
        </p>
      </Card>
    </div>
  );
