  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/shop-builder",
        icon: LayoutGrid,
        description: "Themes, colors, and storefront layout.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        href: "/ai-studio",
        icon: Sparkles,
        description: "Generate product copy and images with AI.",
      },
      {
        id: "agents",
        label: "Agents",
        href: "/agents",
        icon: Bot,
        description: "Automated social posts and campaign drafts.",
      },
      {
        id: "integrations",
        label: "Integrations",
