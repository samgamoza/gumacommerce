import { planDisplayName, type StorePlan } from "@/lib/storefront-plans";
  ...
  return (
    <span
      ...
      style={{
        ...
        color: isAdvance ? "#422006" : "#fff",
        boxShadow: isAdvance
          ? "0 2px 8px rgba(251,191,36,0.35)"
          : "0 2px 8px rgba(5,150,105,0.3)",
      }}
    >
      {isAdvance ? `👑 ${planDisplayName("pro")}` : `⚡ ${planDisplayName("growth")}`}
    </span>
  );
}
